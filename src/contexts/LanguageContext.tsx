...
const translations = {
  en: {
    ...
    // Login
    login: 'Login',
    loginDescription: 'Access your AgriWat dashboard to manage your smart irrigation system',
    email: 'Email Address',
  ...
  hi: {
    ...
    // Login
    login: 'लॉगिन',
    loginDescription: 'अपने स्मार्ट सिंचाई सिस्टम को प्रबंधित करने के लिए अपने AgriWat डैशबोर्ड तक पहुंचें',
    email: 'ईमेल पता',
  ...
  te: {
    ...
    heroDescription: 'తెలివైన నీటి నిర్వహణ, పంట పర్యవేక్షణ, మరియు AI-నడిచే అంతర్దృష్టులతో వ్యవసాయంలో విప్లవం తెస్తూ, మా విలువైన నీటి వనరులను సంరక్షిస్తోంది.',
    ...
    predictiveDesc: 'చారిత్రక డేటా మరియు వాతావరण అంచనాలు AI మోడల్‌ల ద్వారా ప్రాసెస్ చేయబడతాయి.',
    ...
    smartIrrigationDesc: 'వాస్తవ సమయ నేల పరిస్థితులు, వాతావరण డేటా మరియు పంట అవసరాల ఆధారంగా స్వయంచాలక నీటిపారుదల షెడ్యూలింగ్.',
    waterUsageDashboard: 'నీటి వినియోగ డాష్‌బోర్డ్',
    waterDashboardDesc: 'చర్య తీసుకోదగిన అంతర్దృష్టులతో నీటి వినియోగ నమూనాల సమగ్ర విశ్లేషణ మరియు దృశ్యీకరण.',
    ...
    envMonitoringDesc: 'పంట ఆరోగ్యం మరియు నీటి సామర్థ్యాన్ని ప్రభావితం చేసే పర్యావరण కారకాల నిరంతర పర్యవేక్షణ.',
    ...
    // Login
    login: 'లాగిన్',
    loginDescription: 'మీ స్మార్ట్ నీటిపారుదల వ్యవస్థను నిర్వహించడానికి మీ AgriWat డాష్‌బోర్డ్‌ను యాక్సెస్ చేయండి',
